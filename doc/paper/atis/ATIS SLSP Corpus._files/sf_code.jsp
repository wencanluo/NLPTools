...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.2.7.7";
...
//        }
        ...
        var trMP = 'padding-left:'+t.transPad+'px;';
        if (b.inimgDisplayBox == 6 || b.inimgDisplayBox == 3) {
            trMP = 'margin-left:'+t.transPad+'px;margin-right:'+t.transPad+'px;';
        }
    ...
    ih : function(it, i, ind) {
        if (it) {
            ...
            var pos2 = t.b.inimgDisplayBox == 0 || t.b.inimgDisplayBox == 0 ? 'top: 47px;' : 'bottom: 3px;';
