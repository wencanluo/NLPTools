...
if( window == top ){
    ...
    var userid, dlsource, version, sessionid;
    var debugMode = false;
...
();
    ...
    function init(timeCalc){
        ...
        sfWatchCount = null;
        userid = dlsource = version = sessionid = "na";

        sfWatchCount = window.setTimeout(enoughWatching,12000);
    ...
    blacklistHandler: blacklistHandler = function(){
        ...
        var CPNblacklist = ";stackoverflow.com;delta-search.com;pandora.com;go.com;facebook.com;mycouponbuddy.com;yahoo.com;cashnetusa.com;hulu.com;google.com;ebay.com;ihg.com;publicstorage.com;youtube.com;travelocity.com;";
        var CPNenabled = "1|1";
